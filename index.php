...
<title>Cícero Leonardo - Analista de Sistemas</title>
<meta name="description" content="">
<meta name="author" content="infsolution">
    ...
    <div class="container">
      <div class="row">
        <div class="intro-text">
          <h1>Olá, Eu sou <span class="name">Cícero Leonardo</span></h1>
  ...
  <nav class="navbar navbar-custom">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand page-scroll" href="#page-top">Cícero Leonardo</a> </div>
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
        <ul class="nav navbar-nav">
          ...
          <li> <a class="page-scroll" href="#resume">Resumo</a> </li>
          <li> <a class="page-scroll" href="#contact">Contatos</a> </li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-md-offset-2">
        <div class="about-text">
          <p>Meu nome é Cícero, tenho <?php echo (date("Y")-1980)  ?> anos, sou natural de Teresina-Pi, sempre gostei de tecnologia, tive meu primeiro contato com computador aos 11 anos, quando era o aluno mais novo de uma turma com média de idade de 26 anos, na época ainda não havia internet em Teresina, me apaixonei ainda mais pela coisa, mas computador era um luxo para pouquíssimos.</p>
          <p>Quinze anos depois, voltei ao curso de informática e reacendeu minha paixão, daí não parei mais, posteriormente fiz um curso técnico em informática, uma graduação em Administração e finalmente, realizei meu sonho, fui aprovado para cursar Análise e Desenvolvimento de Sistemas no Instituto Federa do Piauí.</p>
          <p class="text-center"><a class="btn btn-primary" href="content/curriculo.pdf" target="_blank"><i class="fa fa-download"></i> Baixe um curriculo</a></p>
        </div>
      </div>
    </div>
  </div>
          ...
          <li>
            ...
            <div class="timeline-panel">
              <div class="timeline-heading">
                <h4>Webni Digital</h4>
                <h4 class="subheading">Desenvolvedor</h4>
              </div>
              <div class="timeline-body">
                <p>Na Webni atendendo as demandas de desenvolvimento em php, nodejs, Woodpress e Woocommerce.</p>
              </div>
            </div>
          </li>
  ...
  <div class="container">
    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="col-md-4"> <i class="fa fa-map-marker fa-2x"></i>
        <p>Rua cento e três Nº 489, Parque União<br>
          Timon, MA</p>
      </div>
      <div class="col-md-4"> <i class="fa fa-envelope-o fa-2x"></i>
        <p>ciceroleonardodasilva@gmail.com</p>
      </div>
...
<div id="footer">
  <div class="container text-center">
    <div class="fnav">
      <p>Copyright &copy; <?php echo date("Y")?> Cícero Leonardo. Desenvolvido por <a href="http://infsolution.com.br" rel="nofollow">Infsolution</a></p>
    </div>
  </div>
</div>
